    ...
    @push('crud_fields_scripts')
        <script>
            ...
            function bpFieldInitAddressGoogleElement(element) {
                ...
                var circle = new google.maps.Circle({ center: new google.maps.LatLng(40.62805333068833, 22.947914792653005), radius: 49998 });
        ...
        <script src="https://maps.googleapis.com/maps/api/js?v=3&key={{ $field['api_key'] ?? config('services.google_places.key') }}&libraries=places&callback=initGoogleAddressAutocomplete&language=el" async defer></script>
