...
return [
    ...
    */
    ...
    'recaptcha' => 'Παρακαλώ, ελέγξτε το πεδίο Recaptcha.',
    'failed' => 'Τα στοιχεία εισόδου δεν ταιριάζουν σε κάποια εγγραφή.',
    'throttle' => 'Πάρα πολλές προσπάθειες εισόδου. Παρακαλώ, προσπαθήστε ξανά σε :seconds δευτερόλεπτα.',
    'max_attempts' => 'Πάρα πολλές προσπάθειες εισόδου. Ο λογαριασμός σας έχει κλειδωθεί. Επικοινωνήστε με τον διαχειριστή.',
